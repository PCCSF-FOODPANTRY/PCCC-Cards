// ==UserScript==
// @name         DCHF TSV Search (Kiosk Optimized)
...
(function() {
    ...
    function showTSVModal(text) {
        ...
        modal.style.borderRadius = "0";       // kiosk-safe
        modal.style.boxShadow = "none";       // kiosk-safe
        modal.style.transition = "none";      // kiosk-safe
    ...
    function loadTSV_clean() {
        GM_xmlhttpRequest({
            method: "GET",
            url: "https://raw.githubusercontent.com/PCCSF-FOODPANTRY/DCHF-Cards/refs/heads/main/data.tsv",
