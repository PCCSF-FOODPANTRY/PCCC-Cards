...
(function() {
    ...
    function loadTSV_clean() {
        GM_xmlhttpRequest({
            method: "GET",
            url: "https://raw.githubusercontent.com/PCCSF-FOODPANTRY/PCCC-Cards/refs/heads/main/data1.tsv",
    ...
    (client.altlastname || client.altfirstname
        ? "Alt Names: " + client.altlastname + " " + client.altfirstname + "\n"
        : "") +
